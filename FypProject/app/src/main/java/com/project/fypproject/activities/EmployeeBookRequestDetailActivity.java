...
public class EmployeeBookRequestDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_employee_book_request_detail);
        ...
        if ("Action Required".equals(requestState)) {
            ...
            getSelectedTime("helperSelectedTime", layoutSelectedTime);
                        ...
                        if (task.isSuccessful() && task.getResult() != null) {
                            ...
                            if (!Docs.isEmpty()) {
                                ...
                                if (firstName != null && lastName != null) {
                                    ...
                                    Intent intent = new Intent(EmployeeBookRequestDetailActivity.this, ChatActivity.class);
    ...
    private void sendDeclineRequest() {
        db.collection("interview_request")
                .document(requestID)
                .update("agentState", "DomesticHelper Decline",
                        "employerState", "Declined",
                        "translatorState", "DomesticHelper Decline",
