...
public class HandlingHelperActivity extends AppCompatActivity {
    FirebaseFirestore firestore;
    RecyclerView recyclerView;
    HandlingHelperAdapter helperAdapter;
...
//        labelAgeOver50 = findViewById(R.id.labelAgeOver50);
        ...
        helperAdapter = new HandlingHelperAdapter(this, helperInfoList);
    ...
    private void AllData() {
        firestore.collection("MaidInfo").whereEqualTo("agentEmail",user.getEmail())
